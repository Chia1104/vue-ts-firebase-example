...
<template>
  <footer
    ...
    <div
      ...
      <hr class="my-5 border-t-2 border-primary" />
      <div class="w-full grid grid-cols-1 lg:grid-cols-2 text-xl">
        <ul>
          <li class="my-2">
      ...
      <div class="mt-auto text-xl">&copy; {{ year }} VueShop</div>
    </div>
  </footer>
</template>
