  ...
  <article class="w-full">
    <div class="w-full max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-14">
      ...
      <div class="w-full flex justify-center items-center">
        <button class="rounded-full p-3 shadow-2xl hover:bg-[#E6E6FA] transition w-[130px] flex justify-center items-center mr-10">
        ...
        <button class="rounded-full p-1 shadow-2xl hover:bg-[#E6E6FA] transition w-[52px] h-[52px] flex justify-center items-center">
