...
<template>
  <form
    ...
    <component
      ...
      async
      defer />
    <div :data-sitekey="RE_CAPTCHA_KEY" class="g-recaptcha self-center" />
    <button
      type="submit"
      ...
      <span
        class="c-button-secondary transform group-hover:-translate-x-1 group-hover:-translate-y-1 text-base after:content-['_↗']">
        Send
      </span>
    </button>
  </form>
