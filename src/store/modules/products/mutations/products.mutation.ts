...
export const successGetCategoryProducts = (state: productStateType, payload: Product[]) => {
...
export const failGetCategoryProducts = (state: productStateType, payload: string) => {
...
export const hasMoreCategoryProducts = (state: productStateType, payload: boolean) => {
...
export const successGetMoreCategoryProducts = (state: productStateType, payload: Product[]) => {
    state.categoryProducts.isLoading = false;
    state.categoryProducts.isSuccess = true;
    state.categoryProducts.isError = false;
    state.categoryProducts.error = null;
...
export const failGetMoreCategoryProducts = (state: productStateType, payload: string) => {
    state.categoryProducts.isSuccess = false;
    state.categoryProducts.isLoading = false;
    state.categoryProducts.isError = true;
    state.categoryProducts.error = payload;
