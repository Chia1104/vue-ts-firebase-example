...
export const getProductsAction = async (context: any) => {
  ...
  try {
    ...
    if (products.henry_clothes.length < 8)
      context.commit("hasMoreProducts", false);
...
export const getProductsByCategoryAction = async (
  ...
  try {
    ...
    if (products.henry_clothes.length < 8)
      context.commit("hasMoreCategoryProducts", false);
...
export const getMoreProductsByCategoryAction = async (
  context: any,
